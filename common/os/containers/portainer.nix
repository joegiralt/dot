...
in
{
  networking.firewall.allowedTCPPorts = builtins.map (x: pkgs.lib.strings.toInt x) portsList;
  ...
  virtualisation.oci-containers.containers = {
    "portainer" = {
      ...
      labels = {
        ...
        "kuma.portainer.http.url" = "http://${opts.lanAddress}:${toString opts.ports.portainer_web}";
